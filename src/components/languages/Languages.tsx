  ...
  return (
    <div className="w-full sm:w-3/4 lg:w-2/5 mx-auto p-6 text-end pe-0">
      <img
        ...
        width="48"
        height="48"
        className={`inline-block hover:bg-[#ED755D] hover:bg-opacity-40 rounded-full border-0 cursor-pointer ${
      ...
      <img
        ...
        width="48"
        height="48"
        className={`inline-block mx-3 hover:bg-[#ED755D] hover:bg-opacity-40 rounded-full border-0 cursor-pointer ${
